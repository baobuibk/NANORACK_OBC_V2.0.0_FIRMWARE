...
C_SRCS += \
../0_DEV/M1_Driver/UART/uart_driver.c 

OBJS += \
./0_DEV/M1_Driver/UART/uart_driver.o 

C_DEPS += \
./0_DEV/M1_Driver/UART/uart_driver.d 


# Each subdirectory must supply rules for building sources it contributes
0_DEV/M1_Driver/UART/%.o 0_DEV/M1_Driver/UART/%.su 0_DEV/M1_Driver/UART/%.cyclo: ../0_DEV/M1_Driver/UART/%.c 0_DEV/M1_Driver/UART/subdir.mk
...
clean: clean-0_DEV-2f-M1_Driver-2f-UART

clean-0_DEV-2f-M1_Driver-2f-UART:
	-$(RM) ./0_DEV/M1_Driver/UART/uart_driver.cyclo ./0_DEV/M1_Driver/UART/uart_driver.d ./0_DEV/M1_Driver/UART/uart_driver.o ./0_DEV/M1_Driver/UART/uart_driver.su

.PHONY: clean-0_DEV-2f-M1_Driver-2f-UART
